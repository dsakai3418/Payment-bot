...
if user_input := st.chat_input("ここに入力してください..."):
    ...
    # ★システムプロンプト改修：出力フォーマットを厳密にテンプレート化
    ...
    パターンB：確認したいことがある / 質問がある / わからない / 担当と話したい場合
      ...
      【出力テンプレート】
      「ご不明な点があるとのこと、失礼いたしました。

      どのような内容をご確認されたいでしょうか？」
      ...
      （出力の最後に隠しタグ `[EMAIL_RECEIVED:確認したメールアドレス]` `[INQUIRY_CONTENT:ヒアリングした質問内容]` をつける）
